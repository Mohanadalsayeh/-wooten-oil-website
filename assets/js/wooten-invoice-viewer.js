...
detail.innerHTML=`<header class="iv-head iv-classic-head"><div class="iv-company"><span class="iv-brand-mark" aria-hidden="true">WO</span><div><strong>WOOTEN OIL CO INC.</strong><p>Covington, Tennessee</p></div></div><div class="iv-document-heading"><div class="iv-document-title">Invoice</div><h2 id="ivDetailTitle">Invoice</h2><p data-invoice-meta></p></div><button type="button" class="iv-close" data-close aria-label="Close invoice details">×</button></header><div class="iv-body"><p class="iv-status" data-status role="status" aria-live="polite"></p><div data-detail-content></div></div><footer class="iv-foot"><span class="iv-updated" data-updated></span><div class="iv-detail-actions"><button type="button" class="iv-print" data-print disabled>Open PDF</button><button type="button" data-close>Back</button></div></footer>`;
